...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"SleepyGram.SleepyGramDesktop.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"SleepyGram.SleepyGramDesktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"SleepyGram.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"SleepyGram Desktop/SleepyGram.lnk"_q;
	const auto old = u"SleepyGram for Windows/SleepyGram.lnk"_q;
