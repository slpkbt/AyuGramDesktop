...
NSString *appName = @"SleepyGram.app";
NSString *appDir = nil;
...
void RemoveQuarantineFromBundle(NSString *path) {
	...
	RemoveQuarantineAttribute([path stringByAppendingString:@"/Contents/MacOS/SleepyGram"]);
...
int main(int argc, const char * argv[]) {
	...
	if (update) {
		...
		// so it won't be deleted when we will clear the "SleepyGram.app/Contents" folder.
